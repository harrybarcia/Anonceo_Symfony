 ...
 */
final class Version20210830150515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD user_id INT DEFAULT NULL, ADD annonce_id INT DEFAULT NULL');
